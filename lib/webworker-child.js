...
// Had problems with npm and the following (due to indirect circular dependency?);
//   while indexeddbshim only has one of the `devDependencies`, it is currently
//   easier for us to just add the file here
// var indexeddbshim = require('indexeddbshim');
var indexeddbshim = require('./indexeddbshim-UnicodeIdentifiers-node.js');
