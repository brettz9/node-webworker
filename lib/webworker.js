...
var Worker = function(src, opts) {
    ...
    //    ...if credentials=same-origin; only share if same origin (no prior preflight needed) (?)
    ...
    // Per https://html.spec.whatwg.org/multipage/workers.html#importing-scripts-and-libraries
    //    type=module should also throw `TypeError` upon `importScripts` attempt
